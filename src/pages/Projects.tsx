      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <div className="max-w-3xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-4">
                <p className="text-sm font-medium text-tertiary shrink-0">Try to include:</p>
                <div className="flex flex-wrap items-center gap-2">
                    {suggestionChips.map(chip => (
                        <Button 
                            ...
                            variant="outline" 
                            size="sm" 
                            className="bg-surface-elevated rounded-full font-normal text-tertiary border-border hover:bg-surface-hover hover:text-primary transition-colors"
                        >
                            {chip}
                        </Button>
                    ))}
            ...
            <div className="flex items-center gap-2 mb-6">
                <Button variant="outline" className="bg-surface-elevated border-border hover:bg-surface-hover hover:text-primary transition-colors">
            ...
            <Textarea 
                ...
                className="min-h-[200px] text-base bg-surface-elevated border-border text-secondary focus:border-primary focus:ring-primary"
            />
            ...
            <div className="mt-6 border-t border-border pt-6 space-y-4">
                ...
                <div className="p-4 border border-border rounded-lg bg-surface-elevated space-y-2 surface-elevated">
